...
const Home = () => (
    <>
        <main className="flex flex-col items-center justify-center p-10 md:p-24">
            <p className="text-center text-5xl font-semibold md:pb-4 md:text-6xl">It&apos;s pronounced &quot;sweet&quot;</p>
            <div
                className="mt-8 flex flex-col items-center justify-center gap-8 md:flex-row md:gap-14">
                <WordCard word="suite" pronunciation="/swiːt/" audioSrc={SUITE_AUDIO_SRC}/>
                <WordCard word="sweet" pronunciation="/swiːt/" audioSrc={SWEET_AUDIO_SRC}/>
            </div>
        </main>
        <footer className="flex flex-col items-center justify-center p-4">
            <p className="text-center text-xl font-semibold">Read more about the project on:</p>
            <a
            ...
            <p className="mt-4 text-center text-sm">Favicon by <a
